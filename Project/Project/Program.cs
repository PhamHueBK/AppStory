...
namespace Project
{
    ...
    class Program1
    {
        public static void Main()
        {
            string[] x = { "việt", "nòang", "nhw", "nhàngmri" };
            Rule[] allRules = new[]
            {
               new Rule(), new Rule1(),new Rule2(),new Rule3(),new Rule4(),new Rule5(),new Rule6(), new Rule7(),new Rule8(),new Rule9()
               ,new Rule10(),new Rule11(),new Rule12(),new Rule13()
    ...
    class Rule10 : Rule
    {
        ...
        {
            bool flag = true;
            string[] words = { "oa", "oe", "uâ", "uy", "òa", "òe", "uầ", "ùy", "óa", "óe", "uấ", "úy", "ọa", "ọe", "uậ", "ụy", "ỏa", "ỏe", "uẩ", "ủy" };
            char[] key = x.ToCharArray();
            string phu = key[1].ToString() + key[2].ToString();
            //
            if (key[0] == 'n')
    ...
    class Rule13 : Rule
    {
        public override bool IsValid(string x)
        {
            ...
            char[] key = x.ToCharArray();
            if (x.Length > 3)
                phu1 = key[2].ToString() + key[3].ToString();
